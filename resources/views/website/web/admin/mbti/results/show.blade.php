                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.mbti.results.index') }}">ئەنجامەکانی MBTI</a>
                            </li>
                                ...
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted mb-2">
                                            <i class="fas fa-id-card me-1"></i> {{ $student->user->code }}
                                        </p>
        ...
        <div class="row">
                            ...
                            <div class="alert alert-light">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <div class="fw-bold">{{ $answers->first()->created_at->format('Y/m/d - H:i') }}
                                        </div>
                                    </div>
                                    <div class="text-end">
            ...
            <div class="col-xl-8 col-lg-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @foreach (['EI' => ['E' => 'Extraversion', 'I' => 'Introversion'], 'SN' => ['S' => 'Sensing', 'N' => 'Intuition'], 'TF' => ['T' => 'Thinking', 'F' => 'Feeling'], 'JP' => ['J' => 'Judging', 'P' => 'Perceiving']] as $dim => $sides)
                            <div class="mb-4">
                                        ...
                                        @if ($loop->first)
                                            <div class="col-8">
                                                <div class="progress" style="height: 25px;">
                                                    @php
                                                        $percentage =
                                                            $total > 0 ? (($scores[$key] ?? 0) / $total) * 100 : 0;
                                                        $color = match ($dim) {
                                                            'EI' => 'bg-success',
                                                            'SN' => 'bg-info',
                                                            'TF' => 'bg-warning',
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header bg-dark text-white py-3">
                            <h5 class="card-title mb-0"><i class="fas fa-info-circle me-2"></i>وەسفی جۆری
                                {{ $student->mbti_type }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                @if (!empty($strengths))
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="card border-danger h-100">
                                            <div class="card-header bg-danger text-white py-2">
                                                <h6 class="mb-0"><i class="fas fa-exclamation-triangle me-2"></i>لەتەکان
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <ul class="list-unstyled mb-0">
                                    ...
                                    <div class="col-12">
                                        <div class="card border-info">
                                            <div class="card-header bg-info text-white py-2">
                                                <h6 class="mb-0"><i class="fas fa-briefcase me-2"></i>کارە گونجاوەکان
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="d-flex flex-wrap gap-2">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            @if ($student->user->phone)
                                <a href="tel:{{ $student->user->phone }}" class="btn btn-info">
                                    <i class="fas fa-phone me-1"></i>پەیوەندی بە قوتابی
                                </a>
                            @else
                                <button type="button" class="btn btn-info" disabled>
                                    <i class="fas fa-phone me-1"></i>ژمارەی پەیوەندی نییە
                                </button>
                            @endif
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{ route('admin.mbti.results.delete', $student) }}" method="POST"
                        id="resultDeleteForm">
                        @csrf
                        @method('DELETE')
