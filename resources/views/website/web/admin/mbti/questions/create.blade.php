                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled">
                                <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> پرسیارەکە بە شێوەیەکی ڕوون و ڕێک بنووسە</li>
                                <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> ڕیزبەندی پرسیارەکان بە وردی دیاری بکە</li>
                                <li class="mb-2"><i class="fas fa-check-circle text-success me-2"></i> بەشی دروست هەڵبژێرە بۆ پرسیارەکە</li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            <h6 class="text-info"><i class="fas fa-exclamation-triangle me-2"></i>تێبینیەکان:</h6>
                            <ul class="list-unstyled">
                                <li class="mb-2"><i class="fas fa-circle text-warning me-2" style="font-size: 8px"></i> پرسیارەکان بە کوردی دەبێت بێت</li>
                                <li class="mb-2"><i class="fas fa-circle text-warning me-2" style="font-size: 8px"></i> ڕیزبەندی پرسیار کاریگەری لەسەر تاقیکردنەوەکە هەیە</li>
                            </ul>
                        </div>
                    </div>
                </div>
