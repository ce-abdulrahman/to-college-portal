                    ...
                    <table id="questionsTable" class="table table-hover table-centered w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $question->id }}</td>
                                <td>
                                    <span class="badge bg-{{ $question->dimension == 'EI' ? 'primary' : ($question->dimension == 'SN' ? 'success' : ($question->dimension == 'TF' ? 'warning' : 'info')) }}">
                                        {{ $question->dimension }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <span class="badge bg-light text-dark">{{ $question->answers_count ?? $question->answers()->count() }}</span>
                                </td>
                                <td>
