        ...
        <div class="row">
            <div class="col-xl-8 col-lg-10 mx-auto">
                <div class="card">
                    ...
                    <form action="{{ route('admin.mbti.questions.update', $question) }}" method="POST"
                        id="editQuestionForm">
                        @csrf
                        @method('PUT')
                                ...
                                <div>
                                    ...
                                    <div class="d-flex flex-wrap gap-3 mt-2">
                                        ...
                                        <span class="badge bg-success">
                                            <i class="fas fa-calendar me-1"></i>دروستکراوە:
                                            {{ $question->created_at->format('Y/m/d') }}
                                        </span>
                                        <span class="badge bg-info">
                                            <i class="fas fa-history me-1"></i>نوێکراوەتەوە:
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="order" id="order" class="form-control"
                                        value="{{ old('order', $question->order) }}" min="1" max="100"
                                        required>
