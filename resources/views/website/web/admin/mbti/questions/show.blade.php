                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="fw-bold">
                                            @switch($question->dimension)
                                                @case('EI') Extraversion (E) - Introversion (I) @break
                                                @case('SN') Sensing (S) - Intuition (N) @break
                                                @case('TF') Thinking (T) - Feeling (F) @break
                                                @case('JP') Judging (J) - Perceiving (P) @break
                                            @endswitch
                                    ...
                                    <div>
                                        ...
                                        <div class="fw-bold">
                                            @switch($question->side)
                                                @case('E') Extraversion @break
                                                @case('I') Introversion @break
                            ...
                            <div class="card border-success h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="progress" style="height: 10px;">
                                        <div class="progress-bar bg-success" style="width: {{ $question->order }}%"></div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="mb-4">
                                        <label class="text-muted d-flex justify-content-between">
                                            <span>کوردی:</span>
                                            <span class="badge bg-primary">{{ mb_strlen($question->question_ku) }} پیت</span>
                                        </label>
                                    ...
                                    <div>
                                        <label class="text-muted d-flex justify-content-between">
                                            <span>ئینگلیزی:</span>
                                            <span class="badge bg-primary">{{ mb_strlen($question->question_en) }} پیت</span>
                                        </label>
                                        <div class="p-3 bg-light rounded border">
            ...
            <div class="card border-danger">
                ...
                <div class="card-body">
                            ...
                            <div class="row text-center">
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <div class="display-6 fw-bold text-primary">{{ $question->answers()->count() }}</div>
                                        <small class="text-muted">کۆی وەڵامەکان</small>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="p-3 bg-light rounded">
                                        <div class="display-6 fw-bold text-success">{{ round($question->answers()->avg('score') ?? 0, 1) }}</div>
                    ...
                    <div class="mt-4">
                            ...
                            <table class="table table-sm table-hover" id="answersTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge bg-{{ $answer->score >= 7 ? 'success' : ($answer->score >= 4 ? 'warning' : 'danger') }}">
                                                {{ $answer->score }}
                                            </span>
                                        </td>
                                        <td>
                        ...
                        <div class="text-end">
                            <a href="#" class="btn btn-sm btn-outline-primary">بینینی هەموو وەڵامەکان</a>
                        </div>
                    </div>
                    @endif
                </div>
