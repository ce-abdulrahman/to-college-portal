                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name_en" class="form-control" required
                                        value="{{ old('name_en') }}" placeholder="نموونە: College of Engineering">
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <textarea name="geojson_text" rows="4" class="form-control"
                                    ...
                                    <input type="file" name="geojson_file" class="form-control mt-2"
                                        accept=".geojson,.json">
                                </div>
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <div id="location-map"
                                        style="height: 400px; border-radius: 12px; border: 2px solid #dee2e6;"></div>
