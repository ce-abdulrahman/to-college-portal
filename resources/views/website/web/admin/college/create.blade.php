        ...
        <div class="col-12 col-xl-8 mx-auto">
            <div class="card glass fade-in">
                <div class="card-body">
                    ...
                    <form id="collegeForm" action="{{ route('admin.colleges.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="name_en" class="form-label">ناوی کۆلێژ (ئینگلیزی)</label>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="status" name="status" class="form-select" required>
                                    <option value="1" {{ old('status') === '1' ? 'selected' : '' }}>چاڵاک</option>
                                    <option value="0" {{ old('status') === '0' ? 'selected' : '' }}>ناچاڵاک</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea name="geojson_text" rows="4" class="form-control" placeholder='{"type":"FeatureCollection","features":[...]}'>{{ old('geojson_text') }}</textarea>
                                <small class="text-muted">یان فایلی GeoJSON بار بکە:</small>
                                <input type="file" name="geojson_file" class="form-control mt-2" accept=".geojson,.json">
                            </div>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <div class="row g-3 mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <input id="lat" name="lat" type="number" step="0.000001" value="{{ old('lat') }}" class="form-control" readonly>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label">Longitude</label>
                                        <input id="lng" name="lng" type="number" step="0.000001" value="{{ old('lng') }}" class="form-control" readonly>
                                    </div>
                                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('collegeForm').addEventListener('submit', function(e) {
            ...
            if (!latVal || !lngVal) {
                if (!confirm('شوێنێک دیاری نەکراوە. دڵنیایت کە بەبێ شوێن بڕۆیە پێش؟')) {
                    e.preventDefault();
                    return;
                }
            }
