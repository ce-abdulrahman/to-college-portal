                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="university_id" name="university_id" class="form-select" required>
                                        ...
                                        @foreach ($universities as $uni)
                                            <option value="{{ $uni->id }}"
                                                {{ old('university_id', $college->university_id) == $uni->id ? 'selected' : '' }}>
                                                {{ $uni->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="name_en" class="form-control" required
                                        ...
                                        placeholder="نموونە: College of Science">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="status" class="form-label">دۆخ</label>
                                    <select id="status" name="status" class="form-select" required>
                                        <option value="1" {{ old('status', $college->status) == 1 ? 'selected' : '' }}>
                                            چاڵاک</option>
                                        <option value="0"
                                            {{ old('status', $college->status) == 0 ? 'selected' : '' }}>ناچاڵاک</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    @if ($college->image)
                                        ...
                                        <img src="{{ $college->image }}" alt="{{ $college->name }}" class="mt-2"
                                    ...
                                    <div class="row g-3 mt-3">
                                        <div class="col-md-6">
                                            ...
                                            <input id="lat" name="lat" type="number" step="0.000001"
                                                value="{{ old('lat', $college->lat) }}" class="form-control" readonly>
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Longitude</label>
                                            <input id="lng" name="lng" type="number" step="0.000001"
                                                value="{{ old('lng', $college->lng) }}" class="form-control" readonly>
                                        </div>
                                    </div>
