...
@section('content')
    <div class="container-fluid py-4">
        <div class="row g-3">
            <div class="col-lg-8">
                <div id="map" style="height: 78vh; border-radius: 12px; overflow: hidden; border: 1px solid #e5e7eb">
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="btn-group btn-group-sm">
                                <button id="btn-home" class="btn btn-outline-secondary" title="Home"><i
                                        class="bi bi-house"></i></button>
                                <button id="btn-fit" class="btn btn-outline-secondary" title="Fit visible"><i
                                        class="bi bi-aspect-ratio"></i></button>
                                <button id="btn-locate" class="btn btn-outline-secondary" title="My location"><i
                        ...
                        <div class="row g-2 mb-3">
                            <div class="col-4">
                                <button id="btn-toggle-uni" class="btn btn-outline-primary w-100 btn-sm active"><i
                                        class="bi bi-building"></i> Uni</button>
                            </div>
                            <div class="col-4">
                                <button id="btn-toggle-col" class="btn btn-outline-success w-100 btn-sm"><i
                                        class="bi bi-house"></i> Col</button>
                            </div>
                            <div class="col-4">
                                <button id="btn-toggle-dep" class="btn btn-outline-warning w-100 btn-sm"><i
                                        class="bi bi-diagram-3"></i> Dep</button>
                            </div>
                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        const MAP_CONFIG = {
            ...
            apiRoutes: {
                universitiesByProvince: (id) => `{{ url('sadm/api/provinces') }}/${id}/universities`,
                collegesByUniversity: (id) => `{{ url('sadm/api/universities') }}/${id}/colleges`,
                departmentsByCollege: (id) => `{{ url('sadm/api/colleges') }}/${id}/departments`
            }
        };
        ...
        class MapDashboard {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: (data, type, row) => {
                                ...
                                const buttonText = row.type === 'university' ? 'View Colleges' :
                                    'View Departments';
            ...
            async loadColleges(universityId) {
                ...
                try {
                    ...
                    this.updateBreadcrumb([{
                        ...
                        {
                            name: this.currentSelection.parent.name,
                            type: 'province'
                        },
                        {
                            name: this.currentSelection.name,
            ...
            async loadDepartments(collegeId) {
                ...
                try {
                    ...
                    this.updateBreadcrumb([{
                        ...
                        {
                            name: this.currentSelection.parent.parent.name,
                            type: 'province'
                        },
                        {
                            name: this.currentSelection.parent.name,
            ...
            renderMapMarkers(items, type) {
                const layer = this.layers[type + 's'];
                layer.clearLayers();
                ...
                if (this.visibleLayers[type + 's'] && layer.getLayers().length > 0) {
            ...
            updateBreadcrumb(items) {
                ...
                items.forEach((item, index) => {
                    ...
                    if (isLast) {
                        ...
                        const $a = $(
                            `<a href="#" class="text-decoration-none" data-type="${item.type}">${item.name}</a>`
                            );
                        $a.on('click', (e) => {
                            e.preventDefault();
