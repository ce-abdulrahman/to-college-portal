                    ...
                    <div class="row">
                        ...
                        @if($university->lat && $university->lng)
                            <div class="col-md-6 mb-3">
                                <div class="card h-100">
                                    <div class="card-body">
                                        <h6 class="card-title text-muted"><i class="fa-solid fa-map-pin me-2"></i> شوێن</h6>
                                        <p class="card-text">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const universityIcon = L.icon({
            iconUrl: '{{ asset("assets/admin/images/university-marker.png") }}' || 'https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon.png',
            iconSize: [40, 40],
            iconAnchor: [20, 40],
            popupAnchor: [0, -40]
        });
