                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" id="name_en" name="name_en" class="form-control" required
                                        ...
                                        placeholder="نموونە: University of Erbil">
                                ...
                                <div class="col-12">
                                    ...
                                    <div id="university-map-edit" style="height: 400px; border-radius: 12px;"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea id="geojson_text" name="geojson_text" rows="5" class="form-control"
                                        placeholder='{"type":"Feature","geometry":{"type":"Point","coordinates":[44.0092,36.1911]}}'>
@php
...
@endphp
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-select" id="status" name="status" required>
                                        <option value="1" {{ $university->status == 1 ? 'selected' : '' }}>چاڵاک
                                        </option>
                                        <option value="0" {{ $university->status == 0 ? 'selected' : '' }}>ناچاڵاک
                                        </option>
                                    </select>
