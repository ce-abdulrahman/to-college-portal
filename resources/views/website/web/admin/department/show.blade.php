...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      ...
      <form action="{{ route('admin.departments.destroy', $department->id) }}" method="POST" onsubmit="return confirm('دڵنیایت؟');">
        @csrf @method('DELETE')
              ...
              <table class="table table-bordered align-middle">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><span class="chip"><i class="fa-solid fa-layer-group"></i> {{ $department->type }}</span></td>
                  </tr>
