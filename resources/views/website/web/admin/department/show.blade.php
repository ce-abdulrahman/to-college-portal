                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-map-pin me-2"></i> پارێزگا</h6>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-building-columns me-2"></i> کۆلێژ</h6>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-percent me-2"></i> ن. ناوەندی</h6>
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-percent me-2"></i> ن. دەرەوە</h6>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-layer-group me-2"></i> جۆر</h6>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-venus-mars me-2"></i> ڕەگەز</h6>
                        ...
                        <div class="col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <h6 class="card-title text-muted"><i class="fa-solid fa-calendar me-2"></i> دروستکراوە</h6>
                                    <p class="card-text small">{{ $department->created_at?->format('Y-m-d H:i') ?? '—' }}</p>
                                </div>
                            </div>
                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        L.marker([lat, lng], {icon: departmentIcon})
            .addTo(map)
