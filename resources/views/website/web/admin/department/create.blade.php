                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="type" name="type" class="form-select">
                                    <option value="زانستی" {{ old('type') === 'زانستی' ? 'selected' : '' }}>زانستی</option>
                                    <option value="وێژەیی" {{ old('type') === 'وێژەیی' ? 'selected' : '' }}>وێژەیی</option>
                                    <option value="زانستی و وێژەیی" {{ old('type') === 'زانستی و وێژەیی' ? 'selected' : '' }}>هەردوو</option>
                                </select>
                            </div>
