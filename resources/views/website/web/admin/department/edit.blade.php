    ...
    <div class="row">
        <div class="col-12 col-xl-10 mx-auto">
            <div class="card glass fade-in">
                <div class="card-body">
                    <h4 class="card-title mb-4"><i class="fa-solid fa-pen-to-square me-2"></i> {{ __('دەستکاری بەش') }}</h4>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="type" name="type" class="form-select">
                                    <option value="زانستی" @selected(old('type', $department->type) === 'زانستی')>{{ __('زانستی') }}</option>
                                    <option value="وێژەیی" @selected(old('type', $department->type) === 'وێژەیی')>{{ __('وێژەیی') }}</option>
                                    <option value="زانستی و وێژەیی" @selected(old('type', $department->type) === 'زانستی و وێژەیی')>{{ __('هەردوو') }}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="sex" name="sex" class="form-select">
                                    <option value="نێر" @selected(old('sex', $department->sex) === 'نێر')>{{ __('نێر') }}</option>
                                    <option value="مێ" @selected(old('sex', $department->sex) === 'مێ')>{{ __('مێ') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <select id="status" name="status" class="form-select" required>
                                    <option value="1" @selected(old('status', $department->status) == 1)>{{ __('چاڵاک') }}</option>
                                    <option value="0" @selected(old('status', $department->status) == 0)>{{ __('ناچاڵاک') }}</option>
                                </select>
                            </div>
                        </div>
