                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="system_id" name="system_id" required>
                                        ...
                                        @foreach ($systems as $system)
                                            <option value="{{ $system->id }}" @selected($system->id == $department->system_id)>
                                                {{ $system->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('system_id')
                                    ...
                                    <div class="position-relative">
                                        <select class="form-select" id="province_id" name="province_id" required>
                                            ...
                                            @foreach ($provinces as $province)
                                                <option value="{{ $province->id }}" @selected($province->id == $department->province_id)>
                                    ...
                                    <div class="position-relative">
                                        <select class="form-select" id="university_id" name="university_id" required>
                                            ...
                                            @foreach ($universities as $university)
                                                <option value="{{ $university->id }}" @selected($university->id == $department->university_id)>
                                    ...
                                    <div class="position-relative">
                                        <select class="form-select" id="college_id" name="college_id" required>
                                            ...
                                            @foreach ($colleges as $college)
                                                <option value="{{ $college->id }}" @selected($college->id == $department->college_id)>
                                                    {{ $college->name }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $department->name }}" placeholder="ناوی بەش..." required>
                                    @error('name')
                                        <div class="text-danger small mt-1">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="local_score"
                                        name="local_score" value="{{ $department->local_score }}"
                                        placeholder="بۆ نموونە 85.5">
                                </div>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="external_score"
                                        name="external_score" value="{{ $department->external_score }}"
                                        placeholder="بۆ نموونە 78">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" id="type" name="type" required>
                                        ...
                                        <option value="زانستی و وێژەیی" @selected($department->type == 'زانستی و وێژەیی')>زانستی و وێژەیی
                                        </option>
                                    </select>
                                </div>
