    ...
    <div class="container-fluid py-4">
            ...
            <div class="col-12">
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.users.deleted') }}" class="btn btn-sm btn-outline-danger ms-2">
                            <i class="fa-solid fa-trash-can me-1"></i> سڕاوەکان
                        </a>
                        <a href="{{ route('admin.users.admin-referrals') }}" class="btn btn-sm btn-outline-info ms-2">
                            <i class="fa-solid fa-user-shield me-1"></i> سەر بە ئەدمین
                        </a>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3 col-xl-2">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body py-3">
                        <small class="text-muted d-block">Centers</small>
            ...
            <div class="col-6 col-md-3 col-xl-2">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body py-3">
                        ...
                        <h5 class="mb-0 text-danger">{{ $stats['deleted'] ?? 0 }}</h5>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        <div class="d-flex gap-1">
                                            ...
                                            @if ((int) auth()->id() !== (int) $user->id)
                                                <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST"
                                                    onsubmit="return confirm('دڵنیایت لە سڕینەوە؟');">
                                                    @csrf
                                                    @method('DELETE')
