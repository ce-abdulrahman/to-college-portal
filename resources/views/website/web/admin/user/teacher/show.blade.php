                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.teachers.index') }}">لیستی مامۆستایان</a>
                            </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 flex-wrap">
                                                ...
                                                <span
                                                    class="badge {{ $user->teacher->gis ? 'bg-success' : 'bg-secondary' }}">
                                                    <i
                                                ...
                                                <span
                                                    class="badge {{ $user->teacher->queue_hand_department ? 'bg-success' : 'bg-secondary' }}">
                                                    <i
                                                        class="fa-solid {{ $user->teacher->queue_hand_department ? 'fa-check' : 'fa-times' }} me-1"></i>
