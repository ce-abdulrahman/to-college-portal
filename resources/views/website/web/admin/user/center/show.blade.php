                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2 flex-wrap">
                                                ...
                                                <span
                                                    class="badge {{ $user->center->gis ? 'bg-success' : 'bg-secondary' }}">
                                                    <i
                                                ...
                                                <span
                                                    class="badge {{ $user->center->queue_hand_department ? 'bg-success' : 'bg-secondary' }}">
                                                    <i
                                                        class="fa-solid {{ $user->center->queue_hand_department ? 'fa-check' : 'fa-times' }} me-1"></i>
