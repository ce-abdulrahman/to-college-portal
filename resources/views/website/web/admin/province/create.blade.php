...
@section('content')
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-none d-lg-block text-center flex-grow-1">
      <div class="navbar-page-title">{{ __('دروستکردنی پارێزگای نوێ') }}</div>
    </div>
  </div>
      ...
      <div class="card glass fade-in">
        <div class="card-body">
          <h4 class="card-title mb-4">
            <i class="fa-solid fa-map-location-dot me-2"></i> {{ __('دروستکردنی پارێزگا') }}
          </h4>
          ...
          <form action="{{ route('admin.provinces.store') }}" method="POST" class="needs-validation" novalidate>
            ...
            <div class="row g-3">
              ...
              <div class="col-md-8">
                <label for="name" class="form-label">
                  <i class="fa-solid fa-tag me-1 text-muted"></i> ناوی پارێزگا <span class="text-danger">*</span>
                </label>
                <input type="text" id="name" name="name" class="form-control"
                       required minlength="2" placeholder="ناوی پارێزگا...">
            ...
            <div class="d-flex justify-content-end gap-2 mt-4">
              ...
              <button type="submit" class="btn btn-primary">
                <i class="fa-solid fa-plus me-1"></i> پاشەکەوتکردنی پارێزگا
              </button>
            </div>
          </form>
