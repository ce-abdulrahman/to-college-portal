                            ...
                            <div class="row g-3">
                                            ...
                                            <div class="row g-3 mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input id="lat" name="lat" type="number" step="0.000001"
                                                        value="{{ old('lat', $province->lat) }}" class="form-control"
                                                        readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Longitude</label>
                                                    <input id="lng" name="lng" type="number" step="0.000001"
                                                        value="{{ old('lng', $province->lng) }}" class="form-control"
                                                        readonly>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="status" required>
                                        <option value="1"
                                            {{ old('status', $province->status) == 1 ? 'selected' : '' }}>چاڵاک</option>
                                        <option value="0"
                                            {{ old('status', $province->status) == 0 ? 'selected' : '' }}>ناچاڵاک</option>
                                    </select>
                                </div>
