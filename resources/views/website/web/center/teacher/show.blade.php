                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn" data-bs-toggle="modal"
                                                        data-bs-target="#staticBackdrop-s{{ $student->id }}-u{{ $student->user->id }}">
...
@foreach ($students as $student)
    @if ($student->id && $student->user?->id)
        <div class="modal fade" id="staticBackdrop-s{{ $student->id }}-u{{ $student->user->id }}"
            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            aria-labelledby="staticBackdropLabel-s{{ $student->id }}-u{{ $student->user->id }}" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel-s{{ $student->id }}-u{{ $student->user->id }}">
                                        ...
                                        <table class="table table-bordered align-middle">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width:120px">وەسف
                                                    </th>
                                                    <th style="width:120px">نەخشە
                                                    </th>
                                                ...
                                                @forelse ($student->resultDeps as $index => $result_dep)
                                                    ...
                                                    <tr data-lat="{{ $lat ?? '' }}" data-lng="{{ $lng ?? '' }}">
                                                        ...
                                                        <td>
                                                            ...
                                                            @else
                                                                <span class="text-muted small">coords
                                                                    نەهێنراون</span>
                                                            @endif
                                                        </td>
                                                    </tr>
