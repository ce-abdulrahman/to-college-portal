                ...
                <div class="card border-info shadow-lg">
                    <div class="card-header bg-info text-white py-3">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('center.features.request') }}" class="btn btn-light btn-sm">
                    ...
                    <div class="card-body">
                                        ...
                                        @foreach ($requests as $req)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($req->status == 'pending')
                                                        <form method="POST"
                                                            action="{{ route('center.features.cancel-request', $req->id) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        @else
                            <div class="text-center py-5">
                                ...
                                <a href="{{ route('center.features.request') }}" class="btn btn-warning mt-2">
