...
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="mb-4">
            ...
            <a href="{{ route('center.students.edit', $user->student->id) }}" class="btn btn-primary ms-2">
                            ...
                            <div class="table-responsive table-scroll-x">
                                <table class="table table-bordered align-middle">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th><i class="fa-solid fa-percent me-1 text-muted"></i> کۆدی بانگێشتی سەنتەر</th>
                ...
                <div class="card glass fade-in mt-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2 justify-content-center text-center ">
                            <button type="button" class="btn w-25 btn-sm btn-outline-primary" data-bs-toggle="modal"
                                data-bs-target="#{{ $manualModalId }}">
                                <i class="fa-solid fa-list-ol me-1"></i> ڕێزبەندی کردن بە دەستی
                            </button>
                            <button type="button"
                                class="btn w-25 btn-sm {{ (int) ($student->ai_rank ?? 0) === 1 ? 'btn-outline-success' : 'btn-outline-secondary' }}"
                                data-bs-toggle="modal" data-bs-target="#{{ $aiModalId }}">
                                <i class="fa-solid fa-robot me-1"></i> ڕێزبەندی کردن بە سیستەمی ژیری دەستکرد
                            </button>
                        </div>
                    </div>
                </div>
