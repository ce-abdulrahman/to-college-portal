...
<div class="container-fluid p-0" style="min-height: calc(100vh - 76px);">
    ...
    <div class="bg-primary text-white py-3 px-4">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h4 class="mb-1"><i class="fas fa-map-marked-alt me-2"></i>هەڵبژاردنی بەشەکان لەسەر نەخشە</h4>
                <p class="mb-0">قوتابی: {{ $student->user->name }} | کۆد: {{ $student->user->code }}</p>
            </div>
            <div class="text-end">
                <div class="badge bg-light text-dark fs-6">
                    <i class="fas fa-list-check me-1"></i>
                    <span id="selectedCount">{{ $currentCount }}</span> / {{ $maxSelections }} بەش
                </div>
                <a href="{{ route('student.departments.selection') }}" class="btn btn-light btn-sm ms-2">
                    <i class="fas fa-list me-1"></i>بینینی لیست
                </a>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-4 col-lg-3 border-end" style="height: 100%; overflow-y: auto;">
            ...
            <div class="p-3 border-bottom">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" id="searchInput" placeholder="ناوی بەش، زانکۆ، پارێزگا...">
                        ...
                        <div class="list-group list-group-flush">
                            ...
                            <div class="list-group-item py-2 px-0 border-0">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <div>
                                        <span class="badge bg-success me-2">{{ $item->department->local_score }}</span>
            ...
            <div class="p-3 border-top">
                ...
                <div class="d-flex flex-column gap-2">
                    <div class="d-flex align-items-center">
                        <div class="legend-color" style="background-color: #28a745; width: 20px; height: 20px; border-radius: 50%; margin-right: 10px;"></div>
                        <span class="small">بەشە هەڵبژێردراوەکان</span>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="legend-color" style="background-color: #007bff; width: 20px; height: 20px; border-radius: 50%; margin-right: 10px;"></div>
                        <span class="small">بەشە گونجاوەکان</span>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="legend-color" style="background-color: #dc3545; width: 20px; height: 20px; border-radius: 50%; margin-right: 10px;"></div>
                        <span class="small">بەشە ناگونجاوەکان</span>
                    </div>
                    <div class="d-flex align-items-center">
                        <div class="legend-color" style="background-color: #6f42c1; width: 20px; height: 20px; border-radius: 50%; margin-right: 10px;"></div>
...
.marker-green { background: linear-gradient(135deg, #28a745, #218838); }
.marker-blue { background: linear-gradient(135deg, #007bff, #0056b3); }
.marker-red { background: linear-gradient(135deg, #dc3545, #c82333); }
.marker-purple { background: linear-gradient(135deg, #6f42c1, #5a2d9c); }
.marker-gold { background: linear-gradient(135deg, #ffc107, #e0a800); }
</style>
@endpush
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    updateSelectionCounts(response.data.total_selected, response.data.remaining);
