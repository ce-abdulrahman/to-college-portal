                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('student.ai-ranking.results') }}">ئەنجامەکانی AI</a>
                            </li>
                                    ...
                                    @forelse($topDepartments as $index => $dept)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <small
                                                    class="text-muted">{{ $dept->department->university->name ?? '' }}</small>
                                            </td>
                                            <td>
                                                <div class="progress" style="height: 20px;">
                                                    <div class="progress-bar bg-{{ $dept->score >= 80 ? 'success' : ($dept->score >= 60 ? 'info' : 'warning') }}"
                                            ...
                                            <td>
                                                @php
                                                    $factors = is_array($dept->match_factors)
                                                        ? $dept->match_factors
                                                        : json_decode($dept->match_factors, true) ?? [];
                                                    $academic = $factors['academic_match'] ?? 0;
                                                @endphp
                                                <span
                                                    class="badge bg-{{ $academic >= 80 ? 'success' : 'info' }}">{{ $academic }}%</span>
                                            </td>
                                            <td>
                                                @php
                                                ...
                                                @endphp
                                                <span
                                                    class="badge bg-{{ $personality >= 80 ? 'success' : 'info' }}">{{ $personality }}%</span>
                                            </td>
                                            <td>
                                                <a href="{{ route('student.ai-ranking.department-details', $dept->department_id) }}"
                                                    class="btn btn-sm btn-outline-primary" title="وردەکاری">
                            ...
                            <div class="card-body">
                                <div class="list-group list-group-flush">
                                    ...
                                    <div class="list-group-item d-flex justify-content-between">
                                        ...
                                        <span
                                            class="badge bg-danger">{{ $topDepartments->max('score') - $topDepartments->min('score') }}%</span>
                                    </div>
                                </div>
                            </div>
                        </div>
