                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="text-center p-3 border rounded bg-light">
                                    <div
                                        class="fs-4 fw-bold text-{{ $stats['match_level'] == 'زۆر بەرز' ? 'success' : ($stats['match_level'] == 'بەرز' ? 'info' : 'warning') }}">
                                        {{ $stats['match_level'] }}
                                    </div>
                        ...
                        <div class="card border-info mb-4">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @else
                                        <div class="col-12">
                                            <p class="text-muted text-center">کێشەی زانیاری نیە</p>
                                        </div>
                                    @endif
                                </div>
                            </div>
                                    ...
                                    <table class="table table-hover mb-0" id="rankingTable">
                                        ...
                                        <tbody>
                                            @foreach ($rankings as $ranking)
                                                <tr
                                                    class="{{ $ranking->score >= 80 ? 'table-success' : ($ranking->score >= 60 ? 'table-info' : '') }}">
                                                    <td>
                                                        <div
                                                            class="rank-circle {{ $ranking->rank <= 10 ? 'rank-top' : ($ranking->rank <= 30 ? 'rank-medium' : 'rank-low') }}">
                                                            {{ $ranking->rank }}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <div class="small">
                                                            <span
                                                                class="badge bg-primary">{{ $ranking->department->province->name ?? '' }}</span>
                                                            <span
                                                                class="badge bg-info">{{ $ranking->department->type }}</span>
                                                    ...
                                                    <td>
                                                        <div class="score-display">
                                                            <div class="score-value">
                                                                {{ number_format($ranking->score, 1) }}%</div>
                                                    ...
                                                    <td>
                                                        ...
                                                        @php
                                                            ...
                                                            if (
                                                                isset($factors['mark_difference']) &&
                                                                $factors['mark_difference'] > 0
                                                            ) {
                                                                echo '<small class="text-success">+' .
                                                                    $factors['mark_difference'] .
                                                                    ' نمرەی زیادە</small><br>';
                                                            }
                                                            if (
                                                                isset($factors['distance_km']) &&
                                                                $factors['distance_km'] < 100
                                                            ) {
                                                                echo '<small class="text-info">' .
                                                                    number_format($factors['distance_km'], 1) .
                                                                    'km دوور</small>';
                                                            }
                                                        @endphp
                                                    </td>
                                                    <td>
                                                        @php
                                                            $isSelected = $student
                                                                ->resultDeps()
                                                                ->where('department_id', $ranking->department_id)
                                                                ->exists();
                                                        @endphp
