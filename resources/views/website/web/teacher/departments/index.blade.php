    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div class="d-flex gap-2">
                <a href="{{ route('teacher.departments.compare-descriptions') }}" class="btn btn-outline-info">
        ...
        {{-- Filters Section --}}
        <form id="filtersForm" method="GET" action="{{ route('teacher.departments.index') }}">
            <div class="row mb-3">
                <div class="col-md-2">
                                            ...
                                            <ul class="dropdown-menu text-center">
                                                <li>
                                                    <a class="dropdown-item"
                                                        href="{{ route('teacher.departments.show', $department->id) }}">
        ...
        (function() {
            ...
            if (resetBtn) {
                resetBtn.addEventListener('click', function() {
                    window.location = "{{ route('teacher.departments.index') }}";
                });
            }
        })();
    </script>
