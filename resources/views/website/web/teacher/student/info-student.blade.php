...
<div id="choose-num" class="{{ $showNum ? '' : 'd-none' }}">
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-md-4">
            ...
            <div class="input-group">
                ...
                <input type="number" class="form-control @error('parallel_num') is-invalid @enderror"
                    id="parallel_num" name="parallel_num" value="{{ old('parallel_num') }}" required min="0"
                    step="0.01" placeholder="نموونە: 89.50">
                @error('parallel_num')
                    <div class="invalid-feedback">{{ $message }}</div>
                @else
        ...
        <div class="col-12 col-md-4">
            ...
            <div class="input-group">
                <span class="input-group-text"><i class="fa-solid fa-star-half-stroke"></i></span>
                <input type="number" class="form-control @error('evening_num') is-invalid @enderror"
                    id="evening_num" name="evening_num" value="{{ old('evening_num') }}" required min="0"
                    step="0.01" placeholder="نموونە: 89.50">
                @error('evening_num')
                    <div class="invalid-feedback">{{ $message }}</div>
                @else
