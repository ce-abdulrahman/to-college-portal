                ...
                <div class="page-title-box d-flex align-items-center justify-content-between">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item active"><a href="#">داشبۆرد</a></li>
                        </ol>
                    </div>
                    <h4 class="page-title">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="{{ route('teacher.departments.index') }}" class="btn btn-outline-primary"
                                    title="Departments">
    ...
    <script>
        ...
        class MapDashboard {
            ...
            renderMapMarkers(items, type) {
                const layerKey = type === 'university' ? 'universities' : type === 'college' ? 'colleges' :
                    'departments';
