...
class TeacherDashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($hasGIS) {
            $isAllDepartments = (int) ($teacher?->all_departments ?? 0) === 1;
            $ownProvinceName = trim((string) ($teacher?->province ?? ''));
            ...
            return view('website.web.teacher.dashboard-gis', compact('teacher', 'mapScope'));
        }
        ...
        return view('website.web.teacher.dashboard-simple', compact('dashboard', 'teacher'));
    }
    ...
    public function compareDescriptions()
    {
        ...
        return view('website.web.admin.department.compare-descriptions', [
            ...
            'departmentsIndexRoute' => route('teacher.departments.index'),
